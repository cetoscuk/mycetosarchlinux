...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(8BBB92ee)", "rgba(2A835Fee)"}, angle = 45 },
            inactive_border = "rgba(092328aa)",
        },
...
hl.bind(mainMod .. " + A", hl.dsp.exec_cmd("/home/cetos/.config/hypr/scripts/screenshot.sh"))
...
-- Lockscreen Animation & Keybind
hl.layer_rule({
    name = "lockscreen-anim",
